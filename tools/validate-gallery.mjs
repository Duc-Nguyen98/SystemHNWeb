...
assert.equal(ids.size, 72, 'Update the reviewed inventory when adding/removing screens');
for (const page of ['index.html', 'previews/overview-filter-v2/index.html']) {
  ...
  assert.equal(cards.length, page === 'index.html' ? 72 : 26);
...
console.log('PASS: 72 originals + 98 gallery links, dimensions, hashes, download targets and root/docs parity.');
