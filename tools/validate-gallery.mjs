...
assert.equal(ids.size, 70, 'Update the reviewed inventory when adding/removing screens');
for (const page of ['index.html', 'previews/overview-filter-v2/index.html']) {
  ...
  assert.equal(cards.length, page === 'index.html' ? 70 : 26);
...
console.log('PASS: 70 originals + 96 gallery links, dimensions, hashes, download targets and root/docs parity.');
